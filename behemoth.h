  ...
  )
{
 ...
 EFI_STATUS Status;
    ...
    EFI_FIRMWARE_MANAGEMENT_PROTOCOL * fwmProto;
    UINTN ImageInfoSize;
    EFI_FIRMWARE_IMAGE_DESCRIPTOR ImageInfo;
    UINT32 DescriptorVersion;
    UINT8 DescriptorCount;
    ...
    Print (L"Initial Status: %d\n", Status);
 Print (L"SystemTable info:\n");
 Print (L"SystemTable: 0x%x\n", (void *)SystemTable);
 Print (L"SystemTable->FirmwareVendor: %s\n", SystemTable->FirmwareVendor);
 Print (L"SystemTable->FirmwareRevision: %ld\n", SystemTable->FirmwareRevision);
 Print (L"SystemTable->ConsoleInHandle: 0x%x\n", (void *)(SystemTable->ConsoleInHandle));
 Print (L"SystemTable->ConIn: 0x%x\n", (void *)(SystemTable->ConIn));
 Print (L"SystemTable->ConsoleOutHandle: 0x%x\n", (void *)(SystemTable->ConsoleOutHandle));
 Print (L"SystemTable->ConOut: 0x%x\n", (void *)(SystemTable->ConOut));
 Print (L"SystemTable->StandardErrorHandle: 0x%x\n", (void *)(SystemTable->StandardErrorHandle));
 Print (L"SystemTable->StdErr: 0x%x\n", (void *)(SystemTable->StdErr));
 Print (L"SystemTable->RuntimeServices: 0x%x\n", (void *)(SystemTable->RuntimeServices));
 Print (L"SystemTable->BootServices: 0x%x\n", (void *)(SystemTable->BootServices));
 Print (L"SystemTable->NumberOfTableEntries: %d\n", SystemTable->NumberOfTableEntries);
 Print (L"SystemTable->ConfigurationTable: 0x%x\n", (void *)(SystemTable->ConfigurationTable));


    Print (L"Locating firmware management protocol...\n");
    ...
    Print (L"Status: %d\n", Status);
    Print (L"fwmProto: 0x%x\n", (void *)fwmProto);

    ImageInfoSize = sizeof(ImageInfo);
    Status = fwmProto->GetImageInfo(
                fwmProto,
                &ImageInfoSize,
                &ImageInfo,
                &DescriptorVersion,
    ...
    Print (L"GetImageInfo Status: %d\n", Status);

 Print (L"Firmware info:\n");
 Print (L"ImageInfoSize: %d\n", ImageInfoSize);
 Print (L"ImageInfo.ImageIndex: %d\n", ImageInfo.ImageIndex);
 Print (L"ImageInfo.ImageTypeId: ");
    PrintGuid (&(ImageInfo.ImageTypeId));
 Print (L"ImageInfo.ImageId: %lld\n", ImageInfo.ImageId);
 Print (L"ImageInfo.ImageIdName: %s\n", ImageInfo.ImageIdName);
 Print (L"ImageInfo.Version: %ld\n", ImageInfo.Version);
 Print (L"ImageInfo.VersionName: %s\n", ImageInfo.VersionName);
 Print (L"ImageInfo.Size: %d\n", ImageInfo.Size);
 Print (L"ImageInfo.AttributesSupported:\n");
    Print (L"  IMAGE_ATTRIBUTE_IMAGE_UPDATABLE:\t%s\n", (ImageInfo.AttributesSupported & 0x0000000000000001 ? L"Yes" : L"No"));
    Print (L"  IMAGE_ATTRIBUTE_RESET_REQUIRED:\t%s\n", (ImageInfo.AttributesSupported & 0x0000000000000002 ? L"Yes" : L"No"));
    Print (L"  IMAGE_ATTRIBUTE_AUTHENTICATION_REQUIRED:\t%s\n", (ImageInfo.AttributesSupported & 0x0000000000000004 ? L"Yes" : L"No"));
    Print (L"  IMAGE_ATTRIBUTE_IN_USE:\t%s\n", (ImageInfo.AttributesSupported & 0x0000000000000008 ? L"Yes" : L"No"));
 Print (L"ImageInfo.AttributesSetting:\n");
 Print (L"ImageInfo.Compatibilities: %lld\n", ImageInfo.Compatibilities);
